...
#####----------------------------------------- 
    ...
    #-----------------------------------------
#
    plotfigure = plotdata.new_plotfigure(name='Tutingish_depth', figno=30)
...
#####----------------------------------------- 
    ...
    #-----------------------------------------
#
    plotfigure = plotdata.new_plotfigure(name='Tutingish_speed', figno=31)
    plotfigure.show = False
    plotfigure.kwargs = {'figsize':[15,15]}
...
#####----------------------------------------- 
    ...
    #-----------------------------------------
#
    plotfigure = plotdata.new_plotfigure(name='Tutingish_stress', figno=32)
    plotfigure.show = False
    plotfigure.kwargs = {'figsize':[15,15]}
    ...
    plotitem.pcolor_cmax = 7000  #make this reasonable max stress
    plotitem.add_colorbar = True    #turn off for making movies
    plotitem.amr_celledges_show = [0]
    plotitem.amr_patchedges_show = [0] 
...
#####----------------------------------------- 
    # Tuting zoomed (depth) arrives here in Frame 16, t = 1.44e04
    #-----------------------------------------
#
    plotfigure = plotdata.new_plotfigure(name='Tuting_depth', figno=33)
    plotfigure.show = False
    plotfigure.kwargs = {'figsize':[15,15]}
    ...
    #plotaxes.title = 'Water Surface'
    plotaxes.scaled = True
    plotaxes.xlimits = [94.85,95.0]
    plotaxes.ylimits = [28.9,29.05]
...
#####----------------------------------------- 
    ...
    #-----------------------------------------
#
    plotfigure = plotdata.new_plotfigure(name='Tuting_speed', figno=34)
...
#####----------------------------------------- 
    # Tuting zoomed (stress)
    #-----------------------------------------
#
    plotfigure = plotdata.new_plotfigure(name='Tuting_stress', figno=35)
    plotfigure.show = False
    plotfigure.kwargs = {'figsize':[15,15]}
    ...
    plotitem.pcolor_cmap = geoplot.custom_river
    plotitem.pcolor_cmin = 0
    plotitem.pcolor_cmax = 2000  #make this reasonable max stress
    plotitem.add_colorbar = True    #turn off for making movies
    plotitem.amr_celledges_show = [0]
    plotitem.amr_patchedges_show = [0] 
...
#-----------------------------------------
    ...
    plotdata.print_framenos = [15,16,17]       #frame is a timestep, so this is the way
